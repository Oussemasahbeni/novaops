...
public class StorageException extends ApplicationException {
    ...
    protected StorageException(ExceptionType type, Throwable cause, Object[] valueParams, Object... keyParams) {
    ...
    protected StorageException(ExceptionType type, String message, Throwable cause, Object... keyParams) {
    ...
    public enum CloudStorageExceptionType implements ExceptionType {
        ...
        TIMEOUT(
                "error.server.storage.title.timeout",
                "error.server.storage.msg.timeout",
                "Operation timed out"
        );
